const translations = {
  ...
  merchant: 'For Merchants'
    ...
    detail: {
      ...
      closed: 'Closed',
      reviews: 'reviews',
      hoursTooltip: 'View full schedule',
      writeReview: 'Write a review',
      writeReviewHint: 'Rate, add photos and share your experience.',
      photoWall: 'Photos',
      ...
      contentPlaceholder: 'Describe your experience...',
      ...
      stars: 'stars',
      openLabel: 'Open',
      wardVenuesTitle: 'Venues in',
      wardVenuesEmpty: 'No venues available in this ward yet.',
  ...
  merchant: 'Dành cho thương nhân'
    ...
    detail: {
      loading: 'Đang tải địa điểm...',
      notFound: 'Không tìm thấy địa điểm',
      backHome: 'Quay về trang chủ',
      untitled: 'Địa điểm chưa đặt tên',
      foodCategory: 'Ẩm thực',
      ...
      closed: 'Đã đóng cửa',
      reviews: 'đánh giá',
      hoursTooltip: 'Xem giờ hoạt động',
      writeReview: 'Viết Bình Luận',
      writeReviewHint: 'Chia sẻ trải nghiệm, đánh giá và thêm hình ảnh.',
      photoWall: 'Hình ảnh',
      viewAllPhotos: 'Xem tất cả hình',
      ratingLabel: 'Đánh giá sao',
      titleLabel: 'Tiêu đề',
      contentLabel: 'Nội dung',
      titlePlaceholder: 'Thêm tiêu đề ngắn',
      contentPlaceholder: 'Mô tả trải nghiệm của bạn...',
      ...
      stars: 'sao',
      openLabel: 'Mở cửa',
      wardVenuesTitle: 'Các quán trong',
      wardVenuesEmpty: 'Chưa có quán nào trong phường này.',
      filterByCategory: 'Lọc theo danh mục',
      privateEvents: 'Sự kiện riêng tư',
      private: 'Riêng tư'
    },
    sections: {
      food: 'Đồ ăn',
